...
Module._resolveFilename = function (request, parentModule, isMain, options) {
  ...
  console.log(
    '_resolveFilename',
    oldResolveFilename.call(this, request, parentModule, isMain, options),
  )
  // return 'D:\\code\\y-packages\\packages\\y-screw\\test\\test.cjs'

  // if (
  //   oldResolveFilename
  //     .call(this, request, parentModule, isMain, options)
  //     .includes('.mjs')
  // ) {
  //   console.log("__mjs")
  //   return 'D:\\code\\y-packages\\packages\\y-screw\\test\\index.mjs'
  // }
...
function init(options) {
  ...
  for (var key in aliases) {
    if (aliases[key][0] !== '/') {
      aliases[key] = nodePath.join(base, aliases[key])
    }
  }
